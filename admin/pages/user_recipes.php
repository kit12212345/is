          ...
          <tbody class="body_cats">
            ...
            if($count_recipes > 0){
              ...
              for ($i = 0; $i < $count_recipes; $i++) {
                ...
                $user_name = $recipes[$i]['user_name'];
                $status = $recipes[$i]['status'];
                $create_date = $recipes[$i]['create_date'];
                $update_date = $recipes[$i]['update_date'];

                $create_date = strtotime($create_date) + $_SESSION['time_offset'];
                ...
                echo '<span>'.$title.' '.$status.' <br> - '.$lang.'</span>';
                ...
                if($post_status == 'deleted'){
                  ...
                  echo '<a href="?q=add_recipe&edit_item='.$id.'">';
