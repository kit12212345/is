...
';
  ...
  $begin_html .= '<channel>';
  	$begin_html .= '<title>Hluble.com - сайт кулинарных рецептов</title>';
  	$begin_html .= '<link>https://hluble.com</link>';
  	$begin_html .= '<description>Сайт кулинарных рецептов</description>';
  	$begin_html .= '<language>ru-RU</language>';
...
$fd = fopen($root_dir."/rss.rss", 'w') or die("не удалось создать файл");
$str = $begin_html;
fwrite($fd, $str);
fclose($fd);
